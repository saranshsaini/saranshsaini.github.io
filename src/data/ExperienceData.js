export const amazon = {
  ...
  pTags: [
    "Wrote Spark queries in Scala to identify the inputs for a product recommendation algorithm to best target consumer preferences.",
    "Designed infrastructure with AWS Step Functions and Lambdas to automate query testing on large datasets to iterate on possible solutions with minimal manual involvement.",
    "Researched and leveraged Spark optimizations such as Adaptive Query Execution and Bloom filters to reduce compute costs by 70%.",
  ],
};
...
export const capitalone = {
  ...
  title: "Software Engineering Intern",
  pTags: [
    "The Lab is the tech research and development arm of Capital One.",
    "Architected a front to end cloud solution to provide executives a way to digest information regarding the companys patents.",
    "Created a pipeline involving AWS Lambdas triggered by S3 buckets, which are then indexed into Elasticsearch to serve a NodeJS backed ReactJS frontend.",
  ],
};
